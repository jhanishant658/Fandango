    ...
    <body>
                ...
                <div class="movie-info">
                    <div style="width: 75%;">
                        ...
                        <div class="movie-actions">
                            ...
                            <button class="trailer-button" onclick="openTrailerModal('${filmdetail.trailer}')">Xem trailer</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="trailerModal" class="modal">
            <div class="modal-content">
                ...
                <iframe id="trailerFrame" width="800" height="450" src="" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <div class="date">
        ...
        <script>
            function openTrailerModal(trailerUrl) {
                ...
                let embedUrl = trailerUrl.replace("watch?v=", "embed/");
