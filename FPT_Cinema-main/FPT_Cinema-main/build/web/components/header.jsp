...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Css/styleHeader.css?v=9"/>
            ...
            <div class="container1">
                <div class="logo1">
                    <a href="/Project_PRJ301/Home">
                        <img src="img/Fandango.svg.png" alt="logoFPT">
                    </a>
                </div>
                <nav class="main-nav1">
                    ...
                    <div class="auth-btn1">
                        <div class="dropdown1">
                            <div class="dropdown-title1">
                                <span style="margin-right:10px; display: flex; align-items: center" class="material-symbols-outlined">
                                    person
                                </span>
                            ...
                            <div class="dropdown-content1">
                                ...
                                <c:if test="${sessionScope.taiKhoan.role_id == 0}">
                                    <a href="AdminController">Quản trị viên</a>
                                </c:if>
                            </div>
                        </div>
                    </div>
