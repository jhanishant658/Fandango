...
public class AdminEditTicket extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String ticket_id_row = request.getParameter("id");
        if (ticket_id_row != null) {
            try {
                int ticket_id = Integer.parseInt(ticket_id_row);
                Ticket_filmDAO.INSTANCE.deleteTicket(ticket_id);
            } catch (NumberFormatException e) {
                System.err.println("Invalid ticket ID: " + ticket_id_row);
            }
        }
