...
public class AdminEditFilm extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (iu != null) {
            if (!checkUpdate) {
                FilmDAO.INSTANCE.insertFilm(title, category, length, description, age_limit, director, actor, warning_text, publish_time, origin, img, img_background, status, trailer);
            } else {
                FilmDAO.INSTANCE.updateFilm(filmid, title, category, length, description, age_limit, director, actor, warning_text, publish_time, origin, img, img_background, status, trailer);
            }
        }
